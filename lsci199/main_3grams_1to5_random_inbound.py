...
def each_text(texts, text_names, n, alpha=0):
	for i in range(len(texts)):
		...
		pd.DataFrame(df).to_csv(str(n)+"gram_alpha"+str(alpha)+"_1to5_random_inbound_"+str(text_names[i]))
		print("Done! Created "+str(n)+"gram_alpha"+str(alpha)+"_1to5_random_inbound_"+str(text_names[i]))
