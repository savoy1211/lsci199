...
def each_text(texts, text_names, n, alpha=0):
	for i in range(len(texts)):
		...
		pd.DataFrame(df).to_csv("NEW*_"+str(n)+"gram_alpha"+str(alpha)+"_1to5_"+str(text_names[i]))
		print("Done! Created "+"NEW*_"+str(n)+"gram_alpha"+str(alpha)+"_1to5_"+str(text_names[i]))
